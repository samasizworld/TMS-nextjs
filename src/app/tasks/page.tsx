            ...
            <div className={'container m-auto h-[80vh] flex flex-col justify-between'}>
                    ...
                    <tbody className={'bg-white divide-y divide-gray-200'}>
                        {tasks.map((t: any) => (
                            <tr key={t.TaskId} className={''}>
                                ...
                                <button className={'px-2 rounded-full border bg-blue-400  hover:bg-yellow-600'}><Link href={`/tasks/${t.TaskId}`}>View</Link></button>
                            </tr>)
                        )}
                    </tbody>
                </table>
                <div className={'flex justify-center'}>
                    ...
                    <div className={'flex justify-end w-1/4'}>
                        <select className={'text-black'} value={pageSize} onChange={handleDropDown}>
                            {pageSize && pageSize == 1 ? (
                                <>
